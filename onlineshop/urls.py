...
urlpatterns = [
    ...
    path('products_images/create', product_views.create_product_image, name='create_product_image'),
    path('products_images/<int:product_id>', product_views.product_image_details, name='product_image_details'),
